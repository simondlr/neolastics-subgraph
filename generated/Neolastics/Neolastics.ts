...
export class Neolastics extends ethereum.SmartContract {
  ...
  generateSVGFromHash(_hash: Bytes): string {
    let result = super.call(
      "generateSVGFromHash",
      "generateSVGFromHash(bytes32):(string)",
  ...
  try_generateSVGFromHash(_hash: Bytes): ethereum.CallResult<string> {
  ...
  generateSVGofTokenById(_tokenId: BigInt): string {
    let result = super.call(
      "generateSVGofTokenById",
      "generateSVGofTokenById(uint256):(string)",
  ...
  try_generateSVGofTokenById(_tokenId: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "generateSVGofTokenById",
      "generateSVGofTokenById(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
  ...
  try_totalEverMinted(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalEverMinted",
      "totalEverMinted():(uint256)",
      []
